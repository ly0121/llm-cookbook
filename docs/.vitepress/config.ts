...
export default defineConfig({
  title: 'LLM Cookbook',
  description: '大模型应用开发完全手册 — 从原理到实战，系统掌握 LLM/Agent/RAG 全技术栈',
  lang: 'zh-CN',
  base: '/llm-cookbook/',

  head: [
    ['link', { rel: 'icon', href: '/llm-cookbook/favicon.ico' }]
  ],
